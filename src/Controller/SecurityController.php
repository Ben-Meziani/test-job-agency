...
class SecurityController extends AbstractController
{
     ...
     */
    public function forgottenPass(Request $request, UserRepository $user, MailerInterface $mailer, TokenGeneratorInterface $tokenGenerator
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user = $user->findOneByEmail($datas['email']);
